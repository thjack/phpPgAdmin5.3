<?php
	...
	/**
	 * Administrar Vistas Materializadas en una base de datos
         * Manage views materialized in a database
	 *
	 * $Id: views-mat.php,v 1.75 2017/12/07 06:57:43 jvenegasperu Exp $
	 */
	...
	function doSelectRows($confirm, $msg = '') {
		...
		if ($confirm) {
			...
			echo "<form action=\"views-mat.php\" method=\"post\" id=\"selectform\">\n";
	...
	function doDrop($confirm) {
		...
		if ($confirm) { 
			...
			echo "<form action=\"views-mat.php\" method=\"post\">\n";
	...
	function doDefault($msg = '') {
		...
		$views = $data->getViewsMaterialized();
...
//				'vars'	=> array('view' => 'relname'),
	...
	function doTree() {
		...
		$attrs = array(
			...
			'branch' => url('views-mat.php', $reqvars,
				array (
					'action' => 'subtree',
					'view' => field('relname')
				)
