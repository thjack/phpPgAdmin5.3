...
class Postgres extends ADODB_base {
	...
	/**
	 * Return all Extensions in the current database.
	 * @return All Extensions, sorted alphabetically
	 */
	...
	/**
	 * Retorna la lista de todas las vistas materializadas en la base de datos
         * Returns a list of all views materialized in the database
	 * @return All views materialized
	 */
	function getViewsMaterialized() {
		$c_schema = $this->_schema;
		$this->clean($c_schema);
		$sql = "
			SELECT c.relname, pg_catalog.pg_get_userbyid(c.relowner) AS relowner,
