<?php
	...
	function doDefault($msg = '') {
		...
		$misc->printTabs('database','extensions');
		$misc->printMsg($msg);

		// Check that the DB actually supports extensions
		$schemas = $data->getExtensions();
		...
		$misc->printTable($extensions, $columns, $actions, 'schemas-schemas', $lang['strnoschemas']);
